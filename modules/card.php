...
if (is_home()) { ?>
    <?php
    if (_mtx('hot_list_check') || _mtx('git_sticky_b')) { ?>
...
<div id="cardslist" class="cardlist" role="main">
    ...
    if (!is_category()) {
        ...
        the_title(); ?>"><?php
        if(_mtx('lazyload') ){$src = 'data-original';}else{$src = 'src';}
        if (_mtx('cdn_enable') ) {
            if(_mtx('cdn_url_style') ){
            ...
            echo '<img class="thumb" style="width:253px;height:169px" '.$src.'="' . MTX_URL . '/timthumb.php?src=';
            echo post_thumbnail_src();
