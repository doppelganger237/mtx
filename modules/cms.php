...
if(_mtx('cdn_url_style') ){
    ...
    $cats = explode(',', _mtx('git_cat_id') );
    foreach($cats as $the_cat){
        $posts = get_posts(array(
            'category' => $the_cat,
            'numberposts' => _mtx('git_cat_num')
        ));
        if(!empty($posts)):
       ...
       if (_mtx('cdn_enable') ) {
            ...
            echo '<img style="width:185px;height:110px" '.$src.'="' . MTX_URL . '/timthumb.php?src=';
            echo post_thumbnail_src();
