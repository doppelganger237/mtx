...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'MTX(每天学) 主题设置', 'mtx' ),
			'menu_title' => __( 'MTX(每天学) 主题设置', 'mtx' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'mtx-options',
    ...
    <div id="optionsframework" class="postbox">
      <form action="options.php" method="post">
        ...
        <div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( '保存设置', 'mtx' ); ?>" />
          <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认', 'mtx' ); ?>"
						onclick="return confirm( '<?php print esc_js( __( '确定要恢复成默认的配置文件吗!', 'mtx' ) ); ?>' );" />
          <div class="clear"></div>
        </div>
      </form>
    </div> <!-- / #container -->
...
<?php
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '已恢复默认设置.', 'mtx' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( '设置已保存.', 'mtx' ), 'updated fade' );
	}
