...
$theme_options = array(
    '常规选项' => array(
        ...
        array(
            ...
            'id' => 'git_tui',
            'type' => 'textarea',
            'std' => '<li>欢迎访问极客公园网站，WordPress信息，WordPress教程，推荐使用最新版火狐浏览器和Chrome浏览器访问本网站，欢迎加入极客公园<code><a target="_blank" href="https://meitianxue.net/go/qun"><i class="fa fa-qq"></i> QQ群</a></code></li><li>Git主题现已支持滚动公告栏功能，兼容其他浏览器，看到的就是咯，在后台最新消息那里用li标签添加即可。</li><li>最新版Git主题已支持说说碎语功能，可像添加文章一样直接添加说说，新建说说页面即可，最后重新保存固定连接，<a target="_blank" href="https://meitianxue.net/shuo.html">演示地址</a></li><li>百度口碑求点赞啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊<a target="_blank" href="http://koubei.baidu.com/s/meitianxue.net">http://koubei.baidu.com/s/meitianxue.net</a></li><li>如果您觉得本站非常有看点，那么赶紧使用Ctrl+D 收藏极客公园吧</li>'
        ),
        array(
            'name' => '友情链接页面',
    ...
    '社交设置' => array(
        ...
        array(
            ...
            'id' => 'git_weibo',
            'type' => 'text',
            'std' => 'https://meitianxue.net/go/weibo'
        ),
        array(
            'name' => 'Steam',
            'desc' => '填写Steam个人主页链接',
            'id' => 'git_steam',
            'type' => 'text',
            'std' => 'https://steamcommunity.com/id/1013370209/'
        ),
        array(
            'name' => '腾讯微信',
            'desc' => '请输入您的微信号',
    ...
    '底部设置' => array(
        ...
        array(
            ...
            'id' => 'git_footconent2',
            'type' => 'textarea',
            'std' => '<ul><li><a href="https://meitianxue.net/goto/ad" title="云左" target="_blank">云左主机</a></li><li><a href="https://meitianxue.net/go/qiniu" title="七牛云" target="_blank">七牛云</a></li></ul>'
        ),
        array(
            'name' => 'Footer3标题',
        ...
        array(
            ...
            'id' => 'git_footconent3',
            'type' => 'textarea',
            'std' => '<ul><li><a href="https://meitianxue.net/" title="每天学" target="_blank">每天学</a></li>'
        ),
        array(
            'name' => 'Footer4标题',
        ...
        array(
            ...
            'id' => 'git_footcode',
            'type' => 'textarea',
            'std' => 'Copyright © 2020 <a href="/" title="每天学">每天学</a> | <a rel="nofollow" target="_blank" href="/about.html">关于网站</a> | <a rel="nofollow" target="_blank" href="/tags.html">标签汇总</a> | <a rel="nofollow" target="_blank" href="/archive.html">文章归档</a> | <a rel="nofollow" target="_blank" href="/links.html">友情链接</a> | <a href="/sitemap.html" target="_blank" title="站点地图（HTML版）">网站地图</a> | 由 <a rel="nofollow" target="_blank" href="https://meitianxue.net/goto/ad">云左</a> &amp; <a rel="nofollow" target="_blank" href="https://meitianxue.net/go/qiniu">七牛</a> &amp; <a href="/wp-admin">强力驱动</a>'
        ),
        array(
            'name' => '全站底部脚本代码',
