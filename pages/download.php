...
<div class="pagewrapper clearfix">
	...
	<?php while (have_posts()) : the_post(); ?>
		<div class="article-content">
			<!-- 文章上方 -->
			<?php if (_mtx('git_downloadad1')) echo _mtx('git_downloadad1'); ?>
			<h2>资源信息</h2>
			...
			<div class="alert alert-info" role="alert">
				<?php if (_mtx('git_dlpage_dl')) echo _mtx('git_dlpage_dl'); ?>
			</div>
			<h2>免责声明</h2>
			<div class="alert alert-warning" role="alert">
				<p><?php if (_mtx('git_dlpage_mz')) echo _mtx('git_dlpage_mz'); ?></p>
			</div>
			<!-- 下载页横幅 -->
			<?php if (_mtx('git_downloadad2')) echo _mtx('git_downloadad2'); ?>
		</div>
